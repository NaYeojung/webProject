...
<html lang="en">
    <head>
        ...
        <title>Travler : travel destinations</title>
...
body {
  ...
  .start {
    ...
    padding: 12px;
    font-weight: bold;
    box-shadow: 0px 5px 15px rgb(174, 174, 174);
    cursor: pointer;
  }
  #start-link {
...
.btn-primary {
  --bs-btn-color: #fff;
  --bs-btn-bg: #17eeee;
  --bs-btn-border-color: #17eeee;
  --bs-btn-hover-color: #fff;
  --bs-btn-hover-bg: #00dbdb;
  --bs-btn-hover-border-color: #00dbdb;
  --bs-btn-focus-shadow-rgb: 49, 132, 253;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: #17eeee;
  --bs-btn-active-border-color: #17eeee;
...
.pagination {
  ...
  --bs-pagination-active-bg: #17eeee;
  --bs-pagination-active-border-color: #17eeee;
  ...
  .d-print-none {
        ...
        <header class="border-bottom">
            <div class="container">
                <div class="text-center">
                    <h1 style="letter-spacing: 0.07em;">News</h1>
                </div>
            </div>
        </header>
        <!-- Page content-->
    ...
    <body  margin: 0; padding: 0;">
        <footer style="color: #6b6b6b; text-align: center; padding: 10px;">
            ...
            <p style="margin-top: 50px;">&copy; 2023 My web project.</p>
        </footer>
    </body>
</html>
      `;
      ...
      while(i<results.length){
        ...
        <div class="row">
                        <div class="col-lg-6">
                            <!-- Blog post-->
                            <div class="card mb-4">
                                <a href="${results[i].url}"><img class="card-img-top" src="../lib_login/news/img/${results[i].img}" alt="..." /></a>
                                <div class="card-body">
                                    <div class="small text-muted">${results[i].location}</div>
                                    <h3 class="card-title h4" style="letter-spacing: 0.05em;">${results[i].title}</h3>
                                    <p class="card-text" style="font-size: 14px">${results[i].contents}</p>
                                    <a class="btn btn-primary" href="${results[i].url}">View more →</a>
                                </div>
                            </div>
                            <!-- Blog post-->
                            <div class="card mb-4">
                                <a href="${results[i+1].url}"><img class="card-img-top" src="../lib_login/news/img/${results[i+1].img}" alt="..." /></a>
                                <div class="card-body">
                                    <div class="small text-muted">${results[i+1].location}</div>
                                    <h3 class="card-title h4" style="letter-spacing: 0.05em;">${results[i+1].title}</h3>
                                    <p class="card-text" style="font-size: 14px">${results[i+1].contents}</p>
                                    <a class="btn btn-primary" href="${results[i+1].url}">View more →</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <!-- Blog post-->
                            <div class="card mb-4">
                                <a href="${results[i+2].url}"><img class="card-img-top" src="../lib_login/news/img/${results[i+2].img}" alt="..." /></a>
                                <div class="card-body">
                                    <div class="small text-muted">${results[i+2].location}</div>
                                    <h3 class="card-title h4" style="letter-spacing: 0.05em;">${results[i+2].title}</h3>
                                    <p class="card-text" style="font-size: 14px">${results[i+2].contents}</p>
                                    <a class="btn btn-primary" href="${results[i+2].url}">View more →</a>
                                </div>
                            </div>
                            <!-- Blog post-->
                            <div class="card mb-4">
                                <a href="${results[i+3].url}"><img class="card-img-top" src="../lib_login/news/img/${results[i+3].img}" alt="..." /></a>
                                <div class="card-body">
                                    <div class="small text-muted">${results[i+3].location}</div>
                                    <h3 class="card-title h4" style="letter-spacing: 0.05em;">${results[i+3].title}</h3>
                                    <p class="card-text" style="font-size: 14px">${results[i+3].contents}</p>
                                    <a class="btn btn-primary" href="${results[i+3].url}">View more →</a>
                                </div>
                            </div>
                        </div>
                    </div>
